    ...
    data: {
      ...
      documents: {
        create: [
          ...
          {
            parcelId: parcel2.id,
            title: 'सन १९८८ फेरफार नोंद क्र. ५२० व वारस पत्रक (Form VI Mutation F-520)',
            docType: 'FERFAR_REGISTER_COPY',
            cloudinaryPublicId: 'chanda_land_dms/ferfar_520_rajura_105',
            storageUrl: 'https://res.cloudinary.com/dgacmjfbp/image/upload/v1/chanda_land_dms/ferfar_sample.pdf',
            fileSizeBytes: 2850000n,
            mimeType: 'application/pdf',
            recordRoomRackNo: 'R-02',
            recordRoomBundleNo: 'B-04',
            fileNumber: 'FER/1988/RAJ/520',
          },
          {
            parcelId: parcel2.id,
            title: 'SDO राजुरा - कलम ३६अ कारणे दाखवा नोटीस (Show-Cause Notice)',
            docType: 'SHOW_CAUSE_NOTICE',
            cloudinaryPublicId: 'chanda_land_dms/notice_rajura_tribal_45',
            storageUrl: 'https://res.cloudinary.com/dgacmjfbp/image/upload/v1/chanda_land_dms/notice_sample.pdf',
            fileSizeBytes: 1920000n,
            mimeType: 'application/pdf',
            recordRoomRackNo: 'R-01',
            recordRoomBundleNo: 'B-05',
            fileNumber: 'SDO/RAJ/REV/2023/45-N',
          },
        ],
      },
    },
