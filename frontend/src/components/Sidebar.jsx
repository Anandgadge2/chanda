        ...
        >
          ...
          <div
            className={clsx(
              ...
              effectiveCollapsed ? 'justify-center px-0' : 'justify-between px-2 py-0.5'
            )}
          >
            {!effectiveCollapsed && (
            ...
            <div className="relative group">
              <button
                ...
                title={collapsed ? 'साइडबार कायम उघडा ठेवा (पिन करा)' : 'ऑटो-क्लोज सक्षम करा'}
                className={clsx(
                  ...
                  effectiveCollapsed ? 'w-11 h-11 text-slate-600 hover:bg-slate-100' : 'p-1.5'
                )}
              ...
              >
                <PanelLeftClose
                  className={clsx(
                    ...
                    effectiveCollapsed ? 'rotate-180 text-blue-900 scale-110' : 'text-slate-500 group-hover:-translate-x-0.5'
                  )}
                />
              </button>
          ...
          <nav className="space-y-1">
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  <div className={clsx('flex items-center min-w-0', effectiveCollapsed && 'justify-center')}>
                    {/* Icon */}
                    <Icon
                      className={clsx(
