  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
        ...
        <div
          className="relative w-full rounded-2xl sm:rounded-3xl overflow-hidden shadow-md border border-slate-200 bg-slate-950 group h-[320px] sm:h-[400px] lg:h-[440px]"
        ...
        >
          ...
          <div className="absolute inset-x-0 bottom-0 z-20 p-5 sm:p-7 flex flex-col sm:flex-row sm:items-end justify-between gap-4 text-white">
            <div className="max-w-3xl space-y-2">
              ...
              <h2 className="text-xl sm:text-3xl lg:text-4xl font-black text-white leading-tight drop-shadow-md">
                {activeBanner.titleMr}
              </h2>
              <p className="text-xs sm:text-sm text-slate-200 drop-shadow-sm font-medium line-clamp-2">
            ...
            <div className="flex items-center gap-3 self-end sm:self-auto flex-shrink-0">
                ...
                {CHANDRAPUR_BANNERS.map((_, idx) => (
                  <button
                    ...
                    className={`h-2 rounded-full transition-all duration-300 ${
                      idx === currentSlide ? 'w-7 bg-amber-400' : 'w-2 bg-white/40 hover:bg-white/70'
                    }`}
              ...
              <div className="flex items-center gap-1.5 ml-1">
                <button
                  ...
                  className="p-2 rounded-xl bg-white/20 hover:bg-white/30 backdrop-blur-md text-white border border-white/25 transition"
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-5 shadow-xs border border-slate-200 space-y-3.5">
          ...
          >
            ...
            <button
              type="submit"
              className="px-6 py-2 rounded-lg bg-blue-900 hover:bg-blue-800 text-white font-bold text-xs shadow-xs transition flex items-center justify-center gap-1.5 flex-shrink-0"
            >
          ...
          <div className="flex flex-wrap items-center gap-2 pt-0.5 text-xs font-bold">
            <Link
              href="/parcels"
              className="px-3.5 py-1.5 rounded-lg bg-blue-50 hover:bg-blue-100 text-blue-900 border border-blue-200 transition flex items-center gap-1.5"
            >
            ...
            <Link
              href="/cases"
              className="px-3.5 py-1.5 rounded-lg bg-amber-50 hover:bg-amber-100 text-amber-900 border border-amber-200 transition flex items-center gap-1.5"
            >
            ...
            <Link
              href="/reports"
              className="px-3.5 py-1.5 rounded-lg bg-emerald-50 hover:bg-emerald-100 text-emerald-900 border border-emerald-200 transition flex items-center gap-1.5"
            >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          <div className="p-3.5 rounded-xl bg-white border border-slate-200 shadow-2xs flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-slate-800 mt-1">प्रशासकीय तालुके</p>
          ...
          <div className="p-3.5 rounded-xl bg-white border border-slate-200 shadow-2xs flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-slate-800 mt-1">महसूल गावे</p>
          ...
          <div className="p-3.5 rounded-xl bg-white border border-slate-200 shadow-2xs flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-slate-800 mt-1">मूळ शीर्षक साखळी</p>
          ...
          <div className="p-3.5 rounded-xl bg-white border border-slate-200 shadow-2xs flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-slate-800 mt-1">वैधानिक अंमलबजावणी</p>
