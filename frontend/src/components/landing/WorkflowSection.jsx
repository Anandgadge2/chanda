...
export default function WorkflowSection() {
  return (
    <section id="workflow" className="py-16 bg-slate-50 text-slate-900 relative border-b border-slate-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {STEPS.map((stepItem, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-white border border-slate-200 rounded-3xl p-6 flex flex-col justify-between space-y-4 hover:border-slate-400 hover:shadow-md transition duration-200 group"
              >
